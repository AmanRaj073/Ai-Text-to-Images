...
const BuyCredit = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-center text-3xl font-medium mb-6 sm:mb-190">
        Choose the plan
      </h1>
      ...
      <div className="flex flex-wrap justify-center gap-6 text-left">
        {plans.map((item, index) => (
          <div
            key={index}
            className="bg-white drop-shadow-sm bordere rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500"
          >
